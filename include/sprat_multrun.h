...
extern int Sprat_Multrun_Expose(int exposure_length,char *filename,int filename_length);
...
extern int Sprat_Multrun_Exposure_Index_Get(int *index);
extern int Sprat_Multrun_Exposure_Count_Get(int *count);
#endif
